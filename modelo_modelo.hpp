...
SX compute_J_qd(const SX& Q, const SX& Qh, const SX& R, const SX& X0, const SX& X_r, const SX& X_k, const SX& U_k, int k) {
    // Cálculo de P
    ...
    // if (k == 0) {
    //         // std::cout << "Jdentro k0: " << J << std::endl;
    //         std::cout << "xbarra: " << xbarra << std::endl;
    //         std::cout << "hbarra: " << hbarra << std::endl;
    //         std::cout << "ubarra: " << ubarra << std::endl;
    // }
    // if (k == 1) {
    //         std::cout << "Jdentro: " << J << std::endl;
    //         // std::cout << "xbarra: " << std::endl;
    // }
    
    return J;
}

std::tuple<SX, SX, SX, SX> teste(const SX& state, const SX& U, SX& v_i, SX& aak, SX& w_i, const double amost) {
    ...
    // std::cout << "heligiro_i depois: " << heligiro_i << std::endl;

    SX M1 = mtimes_qd_casadi(J_inertia_sx, w_i);
    // std::cout << "M1: " << M1 << std::endl;
    SX cross_p = cross_qd_casadi(-w_i, M1);
    // std::cout << "cross_p: " << cross_p << std::endl;
    ...
    return std::make_tuple(estados_t, v_i, aak, w_i);
}

std::tuple<SX, SX, SX, SX, SX> teste(const SX& state, const SX& u1, SX& p_dot, SX& aak, SX& wb, SX& x_outro, const double amostragem) {
