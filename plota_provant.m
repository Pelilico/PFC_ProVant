...
figure(1);
sgtitle('Position', 'FontWeight', 'bold');
subplot(3, 1, 1);
plot(t, x, '-', 'LineWidth', 2, 'Color', [1 0.5 0]); hold on;
plot(t, xref1, '--', 'LineWidth', 2, 'Color', 'r'); grid on;
ylabel('X (m)'); 
...
subplot(3, 1, 2);
plot(t, y, '-', 'LineWidth', 2, 'Color', [1 0.5 0]); hold on;
plot(t, yref1, '--', 'LineWidth', 2, 'Color', 'r');
ylabel('Y (m)');
%legend('Sim3', 'Ref', 'Sim4',  'Location', 'best');
grid on; box off;

subplot(3, 1, 3);
plot(t, z, '-', 'LineWidth', 2, 'Color', [1 0.5 0]); hold on;
plot(t, zref1, '--', 'LineWidth', 2, 'Color', 'r');
...
figure(2);
sgtitle('Linear Velocities', 'FontWeight', 'bold');

subplot(3, 1, 1);
plot(t, vx, '-', 'LineWidth', 2, 'Color', [1 0.5 0]); hold on;
plot(t, vxref1, '--', 'LineWidth', 2, 'Color', 'r');
ylabel('Vx (m/s)');
%legend('Sim3', 'Ref', 'Sim4',  'Location', 'best');
grid on; box off;
...
subplot(3, 1, 2);
plot(t, vy, '-', 'LineWidth', 2, 'Color', [1 0.5 0]); hold on;
plot(t, vyref1, '--', 'LineWidth', 2, 'Color', 'r');
ylabel('Vy (m/s)');
%legend('Sim3', 'Ref', 'Sim4',  'Location', 'best');
grid on; box off;

subplot(3, 1, 3);
plot(t, vz, '-', 'LineWidth', 2, 'Color', [1 0.5 0]); hold on;
plot(t, vzref1, '--', 'LineWidth', 2, 'Color', 'r');
...
figure(3);
sgtitle('Orientation - Euler Angles', 'FontWeight', 'bold');

% Roll
subplot(3, 1, 1);
plot(t, roll, '-', 'LineWidth', 2, 'Color', [1 0.5 0]); hold on;
plot(t, roll_d, '--', 'LineWidth', 2, 'Color', 'r');
ylabel('Roll (°)');
%legend('Sim3', 'Ref', 'Sim4',  'Location', 'best');
grid on;
box off;
...
% Pitch
subplot(3, 1, 2);
plot(t, pitch, '-', 'LineWidth', 2, 'Color', [1 0.5 0]); hold on;
plot(t, pitch_d, '--', 'LineWidth', 2, 'Color', 'r');
ylabel('Pitch (°)');
%legend('Sim3', 'Ref', 'Sim4',  'Location', 'best');
grid on;
box off;
...
% Yaw
subplot(3, 1, 3);
plot(t, yaw, '-', 'LineWidth', 2, 'Color', [1 0.5 0]); hold on;
plot(t, yaw_d, '--', 'LineWidth', 2, 'Color', 'r');
ylabel('Yaw (°)');
xlabel('Time (s)');
%legend('Sim3', 'Ref', 'Sim4',  'Location', 'best');
grid on;
...
figure(4);
sgtitle('Angular Velocities', 'FontWeight', 'bold');


subplot(3, 1, 1);
plot(t, p, '-', 'LineWidth', 2, 'Color', [1 0.5 0]); hold on;
plot(t, ohmx_ref1, '--', 'LineWidth', 2, 'Color', 'r'); grid on;
ylabel('p (rad/s)'); %legend('Sim3', 'Ref', 'Sim4',  'Location', 'best');


subplot(3, 1, 2);
plot(t, q, '-', 'LineWidth', 2, 'Color', [1 0.5 0]); hold on;
plot(t, ohmy_ref1, '--', 'LineWidth', 2, 'Color', 'r'); grid on;
ylabel('q (rad/s)'); %legend('Sim3', 'Ref', 'Sim4',  'Location', 'best');

subplot(3, 1, 3);
plot(t, r, '-', 'LineWidth', 2, 'Color', [1 0.5 0]); hold on;
plot(t, ohmz_ref1, '--', 'LineWidth', 2, 'Color', 'r'); grid on;
...
% T (N)
subplot(4, 1, 1);
plot(t, con(1, :), '-', 'LineWidth', 2, 'Color', [1 0.5 0]); grid on;
ylabel('T (N)');
%legend('Sim3', 'Ref', 'Sim4',  'Location', 'best');
box off;
...
% \tau_{\phi} (N.m)
subplot(4, 1, 2);
plot(t, con(2, :), '-', 'LineWidth', 2, 'Color', [1 0.5 0]); grid on;
ylabel('\tau_{\phi} (N.m)');
%legend('Sim3', 'Ref', 'Sim4',  'Location', 'best');
box off;
...
% \tau_{\theta} (N.m)
subplot(4, 1, 3);
plot(t, con(3, :), '-', 'LineWidth', 2, 'Color', [1 0.5 0]); grid on;
ylabel('\tau_{\theta} (N.m)');
%legend('Sim3', 'Ref', 'Sim4',  'Location', 'best');
box off;
...
% \tau_{\psi} (N.m)
subplot(4, 1, 4);
plot(t, con(4, :), '-', 'LineWidth', 2, 'Color', [1 0.5 0]); grid on;
ylabel('\tau_{\psi} (N.m)');
xlabel('Time (s)');
%legend('Sim3', 'Ref', 'Sim4',  'Location', 'best');
box off;
%% Gráficos de Forces
figure(6);
sgtitle('Forces', 'FontWeight', 'bold');

subplot(4, 1, 1);
plot(t, f1, '-', 'LineWidth', 2, 'Color', [1 0.5 0]); hold on;
%legend('Sim3', 'Sim4',  'Location', 'best');
ylabel('f1 (N)'); grid on;

subplot(4, 1, 2);
plot(t, f2, '-', 'LineWidth', 2, 'Color', [1 0.5 0]); hold on;
%legend('Sim3', 'Sim4',  'Location', 'best');
ylabel('f2 (N)'); grid on;

subplot(4, 1, 3);
plot(t, f3, '-', 'LineWidth', 2, 'Color', [1 0.5 0]); hold on;
%legend('Sim3', 'Sim4',  'Location', 'best');
ylabel('f3 (N)'); 
% xlabel('Time (s)'); grid on;

subplot(4, 1, 4);
plot(t, f4, '-', 'LineWidth', 2,'Color', [1 0.5 0]); hold on;
%legend('Sim3', 'Sim4',  'Location', 'best');
